    ...
    return (
      <>
        <div className='conditions'>
            <p style={{borderBottom:"solid 2px #000000"}}>Политика конфиденциальности и обработки персональных данных сайта «SoftSeason»</p>
            <div>{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Настоящая Политика конфиденциальности и обработки персональных данных (далее - "Политика")
            ...
            <div>{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Сбор указанных данных осуществляется только при вашем согласии и в целях обработки заказов,
            ...
            <div>{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Мы обязуемся обрабатывать персональные данные наших клиентов в соответствии с применимым
            ...
            <div >{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Мы храним ваши персональные данные только в течение необходимого периода времени в целях
            ...
            <div>{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Вы имеете право запросить доступ к своим персональным данным, в целях исправления неточных
            ...
            <div>{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Интернет-магазин оставляет за собой право вносить изменения в настоящую Политику. Любые
            ...
            <div>{/*-----------------------*/}</div>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Осуществляя заказ на веб-сайте «SoftSeason», покупатель подтверждает свое согласие на сбор и
